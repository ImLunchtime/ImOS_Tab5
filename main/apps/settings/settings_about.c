...
lv_obj_t* create_about_page(lv_obj_t* menu) {
    ...
    lv_obj_set_style_bg_color(device_card, lv_color_hex(0xEEEEEE), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(device_card, lv_color_hex(0xCACACA), 0);
    ...
    lv_obj_set_style_shadow_opa(device_card, LV_OPA_20, 0);
    ...
    lv_obj_set_style_text_color(device_title, lv_color_hex(0x111111), 0);
    ...
    lv_obj_set_style_text_color(device_info, lv_color_hex(0x111111), 0);
    ...
    lv_obj_set_style_bg_color(system_card, lv_color_hex(0xEEEEEE), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(system_card, lv_color_hex(0xCACACA), 0);
    ...
    lv_obj_set_style_shadow_opa(system_card, LV_OPA_20, 0);
    ...
    lv_obj_set_style_text_color(system_title, lv_color_hex(0x111111), 0);
    lv_obj_align(system_title, LV_ALIGN_TOP_MID, 0, 10);
    
    // 系统信息内容
    lv_obj_t* system_info = lv_label_create(system_card);
    lv_label_set_text(system_info, "ImOS b0.1 build 522\n基于Kiwifruit架构构建");
    lv_obj_set_style_text_font(system_info, &simhei_32, 0);
    lv_obj_set_style_text_color(system_info, lv_color_hex(0x111111), 0);
    ...
    menu_create_text(bottom_section, LV_SYMBOL_SETTINGS, "CPU: 双核ESP32P4 @ 400MHz", LV_MENU_ITEM_BUILDER_VARIANT_1);
    
    // 可点击的系统版本 - 添加点击事件
    lv_obj_t* version_item = menu_create_text(bottom_section, LV_SYMBOL_SETTINGS, "系统版本: 0.1 build 522", LV_MENU_ITEM_BUILDER_VARIANT_1);
